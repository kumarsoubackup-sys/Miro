...
1. InsightForge (deep insight retrieval) - Most powerful hybrid retrieval, auto-generates sub-questions with multi-dimensional search
...
class InsightForgeResult:
    ...
    Contains retrieval results for multiple sub-questions, plus consolidated analysis
    """
    query: str
    ...
    def to_text(self) -> str:
        ...
        if self.key_quotes:
            ...
            for quote in self.key_quotes:
                ...
                if skip:
                    continue
                # Truncate overly long content (at sentence boundary, not hard cut)
...
class ZepToolsService:
    ...
    def get_entity_summary(
        ...
        # Search for information related to this entity first
    ...
    def insight_forge(
        ...
        # Step 3: Extract relevant entity UUIDs from edges, only get info for those entities (not all nodes)
        entity_uuids = set()
...
Return a JSON-formatted list of sub-questions."""
    ...
    def panorama_search(
        ...
        Get a panoramic view including all related content and historical/expired information:
        ...
        This tool is suitable for scenarios that need to understand the full picture of events or trace evolution.
        ...
        for edge in all_edges:
            ...
            if is_historical:
                # Historical/expired fact, add timestamp marker
    ...
    def interview_agents(
        ...
        Calls the real OASIS interview API to interview Agents running in a simulation:
        ...
        5. Aggregates all interview results and generates an interview report
        ...
        INTERVIEW_PROMPT_PREFIX = (
            ...
            "4. Answer each question by number, beginning each answer with \"Question X:\" (X is the question number)\n"
            "5. Separate answers to different questions with a blank line\n"
            "6. Answers should be substantive; give at least 2-3 sentences per question\n\n"
        )
    ...
    def _clean_tool_call_response(response: str) -> str:
        """Clean JSON tool-call wrapping from Agent responses and extract the actual content"""
...
Please select at most {max_agents} Agents most suitable for the interview and explain your selection rationale."""
...
- You may use **bold** for key words, but do not use other Markdown syntax"""
