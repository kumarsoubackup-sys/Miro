    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, automatically splits documents into chunks and calls Zep to build a knowledge graph, extracting entities and relations, and forming temporal memory and community summaries
          </p>
