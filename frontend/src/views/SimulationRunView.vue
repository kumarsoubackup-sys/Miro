...
// Get maxRounds from query params at initialization so child component can access it immediately
...
const loadGraph = async (graphId) => {
  // During simulation, auto-refresh won't show full-screen loading to avoid flicker
...
onMounted(() => {
  ...
  // Log maxRounds config (value was obtained from query params at init)
  if (maxRounds.value) {
