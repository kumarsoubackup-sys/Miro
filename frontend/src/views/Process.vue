          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, splits documents into chunks and calls the Zep API to build a knowledge graph, extracting entities and relations
                </div>
              </div>
              
              <!-- Wait for ontology to complete -->
...
const handleNewProject = async () => {
  ...
  if (!pending.isPending || pending.files.length === 0) {
    error.value = 'No pending files to upload, please return to home page'
    loading.value = false
    return
  }
